        ...
        >
          ...
          <header
            className={`transition-all duration-300 ${
              isDark
                ? 'bg-linear-to-r from-purple-900 via-indigo-900 to-blue-900 shadow-2xl'
                : 'bg-linear-to-r from-blue-600 via-purple-600 to-indigo-600 shadow-lg'
            }`}
          >
          ...
          {/* Footer */}
          <footer
            className={`transition-all duration-300 mt-12 md:mt-16 border-t ${
              isDark
